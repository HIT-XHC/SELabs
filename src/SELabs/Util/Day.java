...
/*
   ...
   {  int ja = j;
    ...
    /***************************************************************************/
        ...
        /***************************************************************************/
  /***************************************************************************/
        //从yyyy-mm-dd类型或者yyyy/mm/dd的String转换为Day
        //如果格式不合法，则返回myDate(0,0,0)
        /***************************************************************************/
...
//          int yyyy=year;
 ...
 //         int dd=day;
          ...
          SimpleDateFormat formatter = new SimpleDateFormat("yyyy-MM-dd hh:mm:ss");//建立DateFormat类
